...
<body class="page-my-bookings">
    ...
    <main class="container">
        ...
        <div class="make-bookings-layout">
            <aside class="make-bookings-side" aria-label="Booking lookup">
                <section class="booking-summary">
                    ...
                    <form id="bookingSearchForm" class="search-form" novalidate>
                        ...
                        <button type="submit" id="bookingSearchSubmit" class="btn-primary">Search Bookings</button>
                    </form>
                ...
                <section id="bookingTips" class="booking-tips">
                    <h2>Booking Tips</h2>
                    <ul class="checklist">
            ...
            <section aria-label="Booking search results">
