...
<body class="page-faq">
    <?php kk_render_header(['section' => 'pages', 'active' => 'faq']); ?>
    <?php kk_render_breadcrumbs('pages', [['label' => 'FAQ']]); ?>

    <main class="container">
        <a href="../index.php" class="btn-back">Back to Missions</a>

        <section class="figma-page-intro faq-intro">
            <div>
        ...
        <div class="faq-category">
            ...
            <div class="faq-item">
                <div class="faq-question">
                    <span>Who can apply for free cataract surgery?</span>
                    <span class="faq-toggle" aria-hidden="true">v</span>
                </div>
            ...
            <div class="faq-item">
                <div class="faq-question">
                    <span>Do I need a referral from an eye doctor?</span>
                    <span class="faq-toggle" aria-hidden="true">v</span>
                </div>
                <div class="faq-answer">
        ...
        <div class="faq-category">
            ...
            <div class="faq-item">
                <div class="faq-question">
                    <span>How do I book a slot?</span>
                    <span class="faq-toggle" aria-hidden="true">v</span>
                </div>
                <div class="faq-answer">
            ...
            <div class="faq-item">
                <div class="faq-question">
                    <span>Can I book for a family member?</span>
                    <span class="faq-toggle" aria-hidden="true">v</span>
                </div>
                <div class="faq-answer">
