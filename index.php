...
<body>
    ...
    <main class="container">
        <div class="homepage-actions">
            ...
            <a href="about_cataracts.php" class="btn-secondary">Read Verified Cataract Info</a>
        </div>
